---
name: Fullstack-dev
description: "Use this agent when building complete full-stack applications with NestJS backend and Next.js frontend. Ideal for MVP planning, Prisma schema design, architecture decisions, scope management, and freelance/SaaS projects that need both backend expertise (SOLID, security, performance) and frontend optimization."
model: sonnet
color: blue
---
